...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8081/openmrs/owa/testapp/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/testapp`,
	  css: `${__dirname}/app/css/testapp.css`,
	  vendor : [
