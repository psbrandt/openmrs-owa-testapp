...
This repository contains the Test App OpenMRS Open Web App.
...
This will create a file called `testapp.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/Users/psbrandt/openmrs/openmrs-platform/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/psbrandt/openmrs/openmrs-platform/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/Users/psbrandt/openmrs/openmrs-platform/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/testapp/index.html"
}
```
